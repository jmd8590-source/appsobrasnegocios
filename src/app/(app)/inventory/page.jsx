...
import { Package, Search, Filter, Camera, PenSquare, Pencil, Trash2 } from 'lucide-react';
...
const STATUS_OPTIONS = ['available', 'in_lot', 'sold', 'discarded'];
const CATEGORY_OPTIONS = ['metal', 'wood', 'plastic', 'construction'];
...
export default function InventoryPage() {
  ...
  const [deletingScrap, setDeletingScrap] = useState(null);
            ...
            <CardContent className="p-4">
              ...
              <div className="mb-3">
                ...
                <div className="flex gap-1.5 flex-wrap">
                  ...
                  <Badge variant={scrap.status}>{getStatusLabel(scrap.status)}</Badge>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="w-7 h-7 rounded-lg bg-slate-800 hover:bg-slate-700 flex items-center justify-center transition-colors cursor-pointer"
                    title="Editar"
                  >
                  ...
                  <button
                    ...
                    className="w-7 h-7 rounded-lg bg-slate-800 hover:bg-red-900/40 flex items-center justify-center transition-colors cursor-pointer"
                    title="Eliminar"
                  >
...
// Inline Edit Dialog
function EditScrapDialog({ scrap, onClose, onSave }) {
