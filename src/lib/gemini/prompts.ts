...
export function buildScrapAnalysisPrompt(referenceObject?: ReferenceObject): string {
...
export function buildListingGenerationPrompt(
  materials: Array<{ name: string; weight: number; value: number }>
): string {
